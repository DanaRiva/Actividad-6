...
%Modelo de Energía
 ...
 %generalizada
 dQ2=[diff(diff(Lagrangiano,th2p), th1),diff(diff(Lagrangiano,th2p)),... %Derivamos con respecto a la primera velocidad generalizada th1p para las 3 posiciones articulaciones
     diff(diff(Lagrangiano,th2p), th1p),diff(diff(Lagrangiano,th2p))];%Derivamos con respecto a la primera velocidad generalizada th1p para las 3 velocidades articulaciones
